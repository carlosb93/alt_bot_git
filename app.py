...
# quest_crontab_m = '00 3,11,19 * * *'
# quest_crontab_d = '00 5,13,21 * * *'
# quest_crontab_a = '00 7,15,22 * * *'
# quest_crontab_n = '00 8,16,23 * * *'
...
async def stop_foray(event):
	...
	for bline in buttons:
		for button in bline:
			rand_seconds = random.randrange(0, 120)
			time.sleep(rand_seconds)
			await button.click()
	await client.send_message(config.GROUP, '🗡Foray Intervene ')
